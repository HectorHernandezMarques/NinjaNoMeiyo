#ifndef NINJANOMEIYO_MODELS_CHARACTERS_STATES_RYUNOSUKE_INEDGERIGHTOBSTACLE_H
#define NINJANOMEIYO_MODELS_CHARACTERS_STATES_RYUNOSUKE_INEDGERIGHTOBSTACLE_H
		...
		namespace Characters {
			namespace States {
				namespace Ryunosuke {
					...
					class InEdgeRightObstacle : public State {
					public:
						InEdgeRightObstacle(Characters::Ryunosuke &ryunosuke);
						virtual ~InEdgeRightObstacle();
