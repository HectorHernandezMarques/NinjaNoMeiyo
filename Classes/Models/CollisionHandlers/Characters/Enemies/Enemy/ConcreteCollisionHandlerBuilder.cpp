			...
			namespace Characters {
				namespace Enemies {
					namespace Enemy {
						...
						ConcreteCollisionHandlerBuilder::ConcreteCollisionHandlerBuilder() : collisionHandler(new ConcreteCollisionHandler(Bitmasks::DAMAGER)) {
							//this->collisionHandler = new ConcreteCollisionHandler(Bitmasks::OIL_LEFT_OBSTACLE, *this->collisionHandler);
