...
bool LevelOneScene::init()
{
	...
	*/
    ...
    NinjaM::Node *ryunosuke = new NinjaM::Ryunosuke(visibleSize, Vec2((5)*cocos2d::Sprite::create("BoxSample.png")->getContentSize().width, (5800 / 80)*cocos2d::Sprite::create("BoxSample.png")->getContentSize().height), Vec2::ZERO, "RyunosukeStop0D.png", 0.0, cocos2d::Sprite::create("BoxSample.png")->getContentSize());
