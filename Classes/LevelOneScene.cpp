...
bool LevelOneScene::init()
{
	...
	*/
	...
	((NinjaM::Terrain*)boxED)->spawn(this, EDGE_FLOOR_BITMASK, EDGE_LEFT_OBSTACLE_BITMASK, AIR_BITMASK, CEILING_BITMASK);
	...
	((NinjaM::Terrain*)boxEI)->spawn(this, EDGE_FLOOR_BITMASK, AIR_BITMASK, EDGE_RIGHT_OBSTACLE_BITMASK, CEILING_BITMASK);
