...
bool LevelOneScene::init()
{
	...
	*/
    ...
    NinjaM::Node *ryunosuke = new NinjaM::Ryunosuke(visibleSize, Vec2(visibleSize.width / 2 , visibleSize.height / 2), Vec2::ZERO, "Ryunosuke1D.png", 0.0, cocos2d::Sprite::create("BoxSample.png")->getContentSize());
